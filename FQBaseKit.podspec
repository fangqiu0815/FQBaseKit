...
Pod::Spec.new do |s|
  ...
  s.source_files  = "FQBaseKit" , "FQBaseKit/FQBaseFoundation/*" ,"FQBaseKit/FQBaseHelper/*","FQBaseKit/FQBaseQuartzCore/*","FQBaseKit/FQBaseTool/*",
"FQBaseKit/FQBaseUIKit/*","FQBaseKit/FQBaseUtil/*"
