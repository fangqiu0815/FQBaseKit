...
Pod::Spec.new do |s|
  ...
  s.source_files  = "FQBaseKit" , "FQBaseKit/FQBaseFoundation/*.{h,m}" ,"FQBaseKit/FQBaseHelper/*.{h,m}","FQBaseKit/FQBaseQuartzCore/*.{h,m}","FQBaseKit/FQBaseTool/*.{h,m}",
"FQBaseKit/FQBaseUIKit/*.{h,m}","FQBaseKit/FQBaseUtil/*.{h,m}"
